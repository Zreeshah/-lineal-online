      ...
      <Card className="bg-white h-full">
        ...
        <CardContent>
          <ul className="space-y-3">
            ...
            <li className="flex"><Check className="text-green-500 mr-2 shrink-0" size={20} /><span>{t('whyPerfectItem3')}</span></li>
            <li className="flex"><Check className="text-green-500 mr-2 shrink-0" size={20} /><span>{t('whyPerfectItem4')}</span></li>
            <li className="flex"><Check className="text-green-500 mr-2 shrink-0" size={20} /><span>{t('whyPerfectItem5')}</span></li>
          </ul>
        </CardContent>
      </Card>
    </section>
